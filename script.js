    ...
    var translations = {
        it: {
            ...
            projects: {
                ...
                cronisto_desc: "Gestione progetti da solo o in gruppo: decisioni condivise, stato di avanzamento e partecipanti, tutto in un'unica app.",
                open_app: "Apri l'app",
        ...
        en: {
            ...
            projects: {
                ...
                cronisto_desc: "Manage projects solo or as a team: shared decisions, progress status, and participants, all in a single app.",
                open_app: "Open app",
